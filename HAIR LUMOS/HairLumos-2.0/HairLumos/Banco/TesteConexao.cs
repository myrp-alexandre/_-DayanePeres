...
namespace HairLumos.Banco
{
    ...
    {
        /// <summary>
        /// Classe responsável pela conexão com o banco de dados POSTGRES e execução de comandos de SQL
        /// </summary>
            ...
            public TesteConexao()
            {
                //Essa é de sqlserver _strConexao = @"Data Source=localhost\sqlespress;Initial Catalog=Viagem;Persist Security Info=True;User ID=sa;Password=a12345z";
                _strConexao = "Server = 127.0.0.1; Port = 5432; User Id = postgres; Password = postgres123; Database = banco_engII;";
            ...
            public TesteConexao(string stringConexao)
            {
            ...
            public int ExecutaScalarIntTransacao(bool transacao)
            {
                if (_comandoSQL.CommandText.Trim() == string.Empty)
                    throw new Exception("Não há instrução SQL a ser executada.");
                int retorno;
