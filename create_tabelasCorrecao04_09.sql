...
/* Project file:          Modelagem_HL_Correcao_08_08.dez                 */
/* Project name:                                                          */
/* Author:                                                                */
...
CREATE TABLE TBFISICA (
    ...
    fis_cpf CHARACTER VARYING(40) ,
    fis_rg CHARACTER VARYING(40) ,
    fis_dataNascimento DATE ,
    CONSTRAINT PK_TBFISICA PRIMARY KEY (codPessoa)
);
...
CREATE TABLE TBJURIDICA (
    ...
    CONSTRAINT PK_TBJURIDICA PRIMARY KEY (codPessoa)
);
...
CREATE TABLE TBCONTASRECEBER (
    ...
    codComissao INTEGER ,
    codCaixa INTEGER   NOT NULL,
    codFechamento INTEGER   NOT NULL,
    codFormaPag INTEGER ,
    codPessoa INTEGER ,
...
ALTER TABLE TBCOMPRA ADD CONSTRAINT TBJURIDICA_TBCOMPRA 
    FOREIGN KEY (codPessoa) REFERENCES TBJURIDICA (codPessoa);

ALTER TABLE TBAGENDA ADD CONSTRAINT TBPESSOA_TBAGENDA 
    FOREIGN KEY (codPessoa) REFERENCES TBPESSOA (codPessoa);

ALTER TABLE TBAGENDA ADD CONSTRAINT TBFECHAMENTO_TBAGENDA 
    FOREIGN KEY (codFechamento) REFERENCES TBFECHAMENTO (codFechamento);

ALTER TABLE TBAGENDA ADD CONSTRAINT TBTIPOSERVICO_TBAGENDA 
...
ALTER TABLE TBAGENDA ADD CONSTRAINT TBPACOTESADICIONAIS_TBAGENDA 
    FOREIGN KEY (codContrato, codTipoServico, codPessoa) REFERENCES TBPACOTESADICIONAIS (codContrato,codTipoServico,codPessoa);
...
ALTER TABLE TBCONTRATO ADD CONSTRAINT TBFISICA_TBCONTRATO 
    FOREIGN KEY (codPessoa) REFERENCES TBFISICA (codPessoa);
...
ALTER TABLE TBCONTASRECEBER ADD CONSTRAINT TBFECHAMENTO_TBCONTASRECEBER 
    FOREIGN KEY (codFechamento) REFERENCES TBFECHAMENTO (codFechamento);
