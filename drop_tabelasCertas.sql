...
ALTER TABLE TBAGENDA DROP CONSTRAINT TBFECHAMENTO_TBAGENDA;
...
ALTER TABLE TBCONTASRECEBER DROP CONSTRAINT TBFECHAMENTO_TBCONTASRECEBER;
...
/* ---------------------------------------------------------------------- */
/* Drop table "TBFECHAMENTO"                                              */
/* ---------------------------------------------------------------------- */

/* Drop constraints */

ALTER TABLE TBFECHAMENTO DROP CONSTRAINT PK_TBFECHAMENTO;
